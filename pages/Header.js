...
import { SearchIcon,GlobalAltIcon,MenuIcon,UserCircleIcon, GlobeIcon, GlobeAltIcon, UserIcon } from '@heroicons/react/solid';
        ...
        md:px-10">
            ...
            md:shadow-sm p-2 ">
                <input
                    ...
                    className="flex-grow outline-none  rounded-full 
                    bg-transparent"
                    type="text"
